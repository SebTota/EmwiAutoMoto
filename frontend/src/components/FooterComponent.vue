<template>
  <footer class="text-gray-600 body-font pt-4 max-w-7xl md:px-5">
    <div class="text-xs mx-auto grid grid-cols-3 items-center justify-between p-2 border-t border-t-gray-400">
      ...
      <div class="text-center md:text-right col-span-3 md:col-span-1">
        Poręba Spytkowska, Ul. Malownicza 60<br />
        32-800 Brzesko, tel. 0043 69910156670<br />
        NIP 8691328060, REGON 381871308
      </div>
    </div>
  </footer>
</template>
