<template>
  <div class="sm:px-5 py-4 mx-auto w-full flex sm:flex-nowrap flex-grow">
    <div class="w-full flex bg-gray-300 rounded-lg overflow-hidden py-8 px-14 items-end justify-start relative">
      <iframe
        loading="lazy"
      ...
      ></iframe>
      <div class="bg-white relative flex flex-wrap w-full py-4 rounded shadow-md">
        ...
        <div class="sm:w-1/2 px-6 mt-2 sm:mt-0">
