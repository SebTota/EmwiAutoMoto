    ...
    <main class="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div class="py-16">
        <div class="text-center">
          ...
          <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Nie znaleziono strony.</h1>
          <p class="mt-2 text-base text-gray-500">Niestety, nie udało nam się znaleźć strony, której szukasz.</p>
          <div class="mt-6">
